...
enum ActFunc   {NO_ACT, RELU, SIGMOID};
enum LayerType {NONE, CONV, MAXPOOL, FC};
enum DataType  {WEIGHT, INPUT, PSUM, BIAS, FLAG};
enum Direction {EAST, SOUTH, WEST, NORTH, LOCAL};
